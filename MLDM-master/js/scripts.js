 ...
 */
    ...
    //Сохранение одинаковых элементов
        ...
        /*
        * 4 Функция симметричесая разност*/
            ...
            * */
            function check(str)
            {
                ...
                if(str.length > 0)
                {
                    ...
                    for (let i = 0; i < mass.length; i++) //проверка на четную, если НЕЧЁТНАЯ то ошибка
                    {
                        ...
                        {
                            error_text = 'Ошибка в массиве: ' + str + ' В элементе ' + mass[i];
                            mass = false;
                            break;
                        }
                    }
            ...
            function symmetricDifference()
            {
                ...
                document.getElementById("outSymmetricDifference").innerText = "Симметр. разность массивов: " + result_full;
            }